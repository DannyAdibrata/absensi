        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="jam_kedatangan" class="form-control" placeholder="jam_kedatangan" value="{{$absen->jam_kedatagan}}">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    <strong>Jam Kepulangan</strong>
                    <input type="text" name="jam_kepulangan" class="form-control" placeholder="jam_kepulangan" value="{{$absen->jam_kepulangan}}">
                </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
